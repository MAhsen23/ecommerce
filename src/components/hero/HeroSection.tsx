...
const HeroSection = (props: any) => {
    return (
        <div
            className={`p-6 sm:p-8 md:p-12 ${props.isRounded && props.isRounded == true ? 'rounded-3xl' : 'rounded-none'} h-[400px] sm:h-[450px] ${props.height == "small" ? 'md:h-[400px]' : 'md:h-[500px]'} flex flex-col justify-center bg-cover bg-left`}
