...
const LatestProducts = () => {
    ...
    return (
        <section className="my-28 mx-auto max-w-7xl px-4">
            <div>
                <div className="mb-8">
                    <h2 className="text-2xl font-bold md:font-extrabold md:text-4xl mb-4 text-center">Latest Arrivals</h2>
                    <div className="text-center text-sm md:text-base text-textLight">
                        <p>Discover Our Newest Arrivals to Elevate Your Beauty Routine.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    {products.map((product) => (
                        <ProductCard ratio={'square'} key={product.id} product={product} />
                    ))}
                </div>
            </div>
        </section>
